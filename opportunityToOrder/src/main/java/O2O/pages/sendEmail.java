...
public class sendEmail extends PageObject
{
  ...
  private static final String emailSubjectTxt  = "CCI SYNC : list of actions triggered";
  private static final String emailFromAddress = "srinivasa.kuncha@mailnewspapers.co.uk";

  // Add List of Email address to who email needs to be sent to "Daniel.Ramsey@mailnewspapers.co.uk"
...
//	String str1 = str;
    ...
    smtpMailSender.postMail( emailList, emailSubjectTxt, str, emailFromAddress);
